...
if ($nama === '' || $lokasi === '' || $provinsi === '' || $kategori_id <= 0 || $deskripsi === '') {
...
$stmt = $pdo->prepare("INSERT INTO destinasi
    (nama, lokasi, lat, lng, provinsi, kategori_id, deskripsi, rating, durasi, biaya, biaya_detail, rute, musim, tips, keywords, emoji, foto_url, warna_bg, warna1, warna2)
    VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
